...
Levels of a11y checks (each of which can be part of CI) <br>
	-	 Linters <br>
	-	 Unit tests <br>
	-	 End-to-end tests <br>
	-	 A11y scans <br>
...
Processes - defining critical processes, identifying gaps and proposing improvements <br>
Quality processes - introducing rituals and activities. Shift left identifying risks and preventing risks <br>
Education - teaching testing skills to dev teams <br>
Tools - automating testing and improving efficiency <br> 
Metrics - understanding quality gaps and enabling focus on the most important things <br>
